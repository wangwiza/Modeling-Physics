...
shape = int(input("What rolling shape would you like to see rolling? Accepted answers are 1 for ring, 2 for ssphere, 3 for hsphere, 4 for cyl")) #prompt user for shape
if shape == 2:
    uranus = sphere(pos = vec(-L_ice,0,0), radius = R, texture = "https://i.imgur.com/mXHoSBC.jpeg")
    I = .4 * M * R**2 #moment of inertia of ssphere
    motion()
